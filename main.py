...
# filter out big jumps in water levels so that there is a big jump detected it is ignored by ALL the existing graphs in code
# make a prediction model, either with or without using regression models but make it accurate and the graph has to be smooth, expandable. 1-2 charts

plot_original_vs_filtered(patch, "original_vs_filtered.png")

# sidenote tryout jupyter
plt.show()